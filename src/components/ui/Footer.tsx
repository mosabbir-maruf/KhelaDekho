    ...
    <footer className="border-t border-border-alt bg-page relative z-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          <div className="space-y-4 col-span-2 lg:col-span-1">
            ...
            <p className="text-sm text-fg-faint font-mono leading-relaxed max-w-sm">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5">
              ...
              <li>
                <Link prefetch={false} href="/live-matches" className="text-sm font-mono text-fg-faint hover:text-fg transition-colors">
                  Live Matches
                </Link>
              </li>
              <li>
                <Link prefetch={false} href="/live-tv" className="text-sm font-mono text-fg-faint hover:text-fg transition-colors">
                  Live TV
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5">
              <li>
                <Link prefetch={false} href="/cricket" className="text-sm font-mono text-fg-faint hover:text-fg transition-colors">
                  Cricket
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link prefetch={false} href="/basketball" className="text-sm font-mono text-fg-faint hover:text-fg transition-colors">
                  Basketball
                </Link>
              </li>
              <li>
                <Link prefetch={false} href="/tennis" className="text-sm font-mono text-fg-faint hover:text-fg transition-colors">
                  Tennis
                </Link>
              </li>
              <li>
                <Link prefetch={false} href="/motorsports" className="text-sm font-mono text-fg-faint hover:text-fg transition-colors">
                  Motorsports
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5">
              <li>
                <Link prefetch={false} href="/about" className="text-sm font-mono text-fg-faint hover:text-fg transition-colors">
                  About Us
                </Link>
              </li>
              <li>
      ...
      <div className="border-t border-border-alt/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <p className="text-[10px] sm:text-[11px] font-mono text-fg-muted leading-relaxed text-center">
      ...
      <div className="border-t border-border">
          ...
          <div className="flex items-center gap-4 text-[10px] font-mono text-fg-faint uppercase tracking-widest">
            <span className="flex items-center gap-2">
              <span className="text-fg-faint">VERSION:</span> beta-2.1.1
            </span>
          ...
          <div className="text-[10px] font-mono text-fg-faint uppercase tracking-widest flex flex-col sm:flex-row flex-wrap items-center justify-center sm:justify-end gap-2 sm:gap-3">
            ...
            <span className="mt-1 sm:mt-0 text-fg-faint">A sideproject by </span><Link href="https://github.com/mosabbir-maruf" target="_blank" rel="noopener noreferrer" className="text-fg-faint hover:text-fg transition-colors">Mosabbir Maruf</Link>
          </div>
        </div>
      </div>
    </footer>
