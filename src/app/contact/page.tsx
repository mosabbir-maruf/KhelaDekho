            ...
            {sent ? (
              <div className="text-center py-8 sm:py-16 space-y-5">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 border border-border-alt bg-hover text-xs font-mono text-fg-dim hover:text-fg hover:border-red-500/30 hover:bg-red-500/[0.03] transition-all cursor-pointer"
                >
